...
gh pr create --fill                    # Auto-fill PR from commits
...
gh api user                            # Get current user info

# Gists
gh gist create <file>                  # Create gist from file
gh gist create --secret <file>         # Create private gist
...
gh release create <tag> --notes "..."  # Create with notes
...
gh search users <query>                # Search users
